...
// Personalized search criterias. Example: Param THIRDPARTY_QUICKSEARCH_ON_FIELDS = 's.nom=ThirdPartyName;s.name_alias=AliasNameShort;s.code_client=CustomerCode'
...
$arrayfields=array(
's.rowid'=>array('label'=>"TechnicalID", 'position' => 5, 'checked'=>(getDolGlobalInt('MAIN_SHOW_TECHNICAL_ID')?1:0), 'enabled'=>(getDolGlobalInt('MAIN_SHOW_TECHNICAL_ID')?1:0)),
's.nom'=>array('label'=>"Patient", 'position' => 6, 'checked'=>1),
's.name_alias'=>array('label'=>"AliasNameShort", 'position' => 7, 'checked'=>0),
's.barcode'=>array('label'=>"Gencod", 'position' => 8, 'checked'=>0, 'enabled'=>isModEnabled("barcode")),
'customerorsupplier'=>array('label'=>'Nature', 'position'=>9, 'checked'=>0),
's.code_client'=>array('label'=>"PatientCode", 'position' => 10, 'checked'=>1),
's.code_fournisseur'=>array('label'=>"SupplierCodeShort", 'position' => 11, 'checked'=>0, 'enabled'=>isModEnabled("fournisseur")),
's.code_compta'=>array('label'=>"CustomerAccountancyCodeShort", 'position' => 12, 'checked'=>0),
's.code_compta_fournisseur'=>array('label'=>"SupplierAccountancyCodeShort", 'position' => 13, 'checked'=>0, 'enabled'=>isModEnabled("fournisseur")),
...
's.email'=>array('label'=>"Email", 'position'=>30, 'checked'=>0),
's.url'=>array('label'=>"Url", 'position'=>31, 'checked'=>0),
's.phone'=>array('label'=>"Phone", 'position'=>32, 'checked'=>1),
's.fax'=>array('label'=>"Fax", 'position'=>33, 'checked'=>0),
'typent.code'=>array('label'=>"ThirdPartyType", 'position'=>34, 'checked'=>0),
...
's.tva_intra'=>array('label'=>"VATIntra", 'position'=>48, 'checked'=>0),
