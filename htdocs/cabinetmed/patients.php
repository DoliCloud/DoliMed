...
if ((float) DOL_VERSION >= 9.0)
{
	...
	if ($user->rights->societe->creer)
	{
		...
		$newcardbutton = '<a class="butActionNew" href="'.DOL_URL_ROOT.'/societe/card.php?action=create&canvas=patient'.$typefilter.'"><span class="valignmiddle">'.$langs->trans($label).'</span>';
