...
class modCabinetMed extends DolibarrModules
{
	...
	function __construct($db)
	{
		...
		$this->module_parts = array(
			...
			'hooks' => array('customreport', 'index', 'searchform', 'thirdpartycard', 'thirdpartycontact', 'thirdpartycontactcard', 'thirdpartysupplier', 'thirdpartycomm', 'thirdpartypartnership', 'commcard', 'categorycard', 'contactcard', 'actioncard', 'agendathirdparty', 'projectthirdparty', 'infothirdparty', 'thirdpartybancard', 'thirdpartyconsumption', 'consumptionthirdparty', 'thirdpartynotification', 'thirdpartymargins', 'thirdpartycustomerprice', 'thirdpartyticket', 'documentcabinetmed', 'searchform', 'demo'),
			'moduleforexternal' => 1
		);
		...
		$this->need_dolibarr_version = array(17, 0, -3);   // Minimum version of Dolibarr required by module
