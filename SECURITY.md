...
- Or if you have permissions, use GitHub security advisory at [https://github.com/DoliCloud/DoliMed/security/advisories/new](https://github.com/DoliCloud/DoliMed/security/advisories/new)
